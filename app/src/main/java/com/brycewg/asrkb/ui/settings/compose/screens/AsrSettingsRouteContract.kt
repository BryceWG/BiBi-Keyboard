...
internal data class AsrOnlineSettingsRouteState(
    ...
    val stepAudioCustomModelVisible: Boolean,
    val onStepAudioModelSelected: (String) -> Unit,
    val stepAudioCustomModelDraft: String,
    val onStepAudioCustomModelDraftChange: (String) -> Unit,
